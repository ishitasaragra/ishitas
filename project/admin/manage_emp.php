                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        <tr>
											...
											<td>
                                            <a href="status?statusEmp_id=<?php echo $d->Emp_id;?>" class="btn btn-success me-1"><?php echo $d->status;?></a>
											<a href="delete?delEmp_id=<?php echo $d->Emp_id;?>" class="btn btn-danger me-1">Delete</a>
											   
											<a href="editemp?editEmp_id=<?php echo $d->Emp_id;?>" class="btn btn-primary me-1">Edit</a>
                                            </td>                                       
                                        </tr>
										<?php
											}
